...
- **2026-09-20 Pete kept the two refused-on-criterion changes (short-horizon projection mix, silent screen is not a permit): option (a), merge both.** Both remove a wrong rule rather than tune a knob; ledger 0.3012 -> 0.2921. The criteria were sized for four-election blast radii that turned out wider. `plans/prereg-projection-mix-short-horizons-2026-09-20.md`, `plans/prereg-screen-silent-not-permit-2026-09-20.md`.

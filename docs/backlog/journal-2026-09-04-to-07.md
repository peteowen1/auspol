...
## SESSION 2026-09-07: New South Wales 2019 scored, and four findings — rolled from NEXT-STEPS.md 2026-09-17
...
`scripts/build_vic2026_salience_corpus.R`).
...
D is on). Full evidence:
[journal-2026-09-07-to-08-reentry.md](journal-2026-09-07-to-08-reentry.md).

### Open, in the order I would do them (as of 2026-09-07)
...
1. ~~Seats that changed hands between elections are nearly invisible~~ —
   **WORKED THROUGH 2026-09-16.** `is_incumbent_party` classification bug
   ...
   `docs/reviews/incumbent-classification-bug-2026-09-16.md`.
...
2. **The statewide covariance is settled for now.** Leakage closed
   ...
   Both changes measured as ties. `docs/reviews/statewide-cov-loo-2026-09-07.md`.
...
4. **~~Two elections still unfound~~ — STALE, corrected 2026-09-11.** sa2018
   ...
   (`AUSPOL_SA_PAIR="2022"`). The Queensland recipe applies: the commission's
   old results site published a package per election and the archive kept
   it, which is what made qld2017 available after it had been written off.

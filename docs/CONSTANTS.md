...
|---|---|---|---|
| `SHRINK = 0.02` | `fit_seats_full.R:827` | Per-draw calibration shrink toward a coin toss in close seats. Added 2026-08-21 at 0.10; **lowered to 0.02 on 2026-09-06**. A scalar shrink caps every seat at `1 - shrink/2`, so 0.10 meant no seat could be called above 0.95 — measured max p was 0.9505 with 19 of 150 federal seats against that ceiling, costing ~0.006 of mean log loss on the cap alone. Swept on fed2025: 0.10→0.3042, 0.05→0.2933, **0.02→0.2891**, 0.00→0.2914. Three seeds at 0.02 mean 0.2886 against AE Forecasts' 0.3025. Validated election-wide before shipping: federal mean log 0.4154→0.4047 (better in 5 of 6 pairs, Brier in 6 of 6), Victoria 0.3020→0.2997, NSW 0.4062→0.3822, SA 0.3976→0.3857, WA accuracy 87.0%→87.3%. Stays non-zero because 0.00 scores worse (0.2914). | **ESTIMATED** — swept on held-out log loss, then checked election-wide as a do-no-harm guard. |
